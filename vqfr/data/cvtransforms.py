...
import vqfr.data.cvfunctional as F

__all__ = [
    'Compose', 'ToTensor', 'ToCVImage', 'Normalize', 'Resize', 'CenterCrop', 'Pad', 'Lambda', 'RandomApply',
    'RandomOrder', 'RandomChoice', 'RandomCrop', 'RandomHorizontalFlip', 'RandomVerticalFlip', 'RandomResizedCrop',
    'FiveCrop', 'TenCrop', 'LinearTransformation', 'ColorJitter', 'RandomRotation', 'RandomAffine', 'RandomAffine6',
    'RandomPerspective', 'Grayscale', 'RandomGrayscale', 'RandomGaussianNoise', 'RandomPoissonNoise', 'RandomSPNoise'
]
...
class RandomPerspective(object):
    ...
    @staticmethod
    def get_params(fov_range, anglex_ranges, angley_ranges, anglez_ranges, shear_ranges, translate, scale_ranges,
                   img_size):
        ...
        scale = (random.uniform(1 / scale_ranges[0],
                                scale_ranges[0]), random.uniform(1 / scale_ranges[1], scale_ranges[1]))
    ...
    def __call__(self, img):
        ...
        """
        ret = self.get_params(self.fov, self.anglex, self.angley, self.anglez, self.shear, self.translate, self.scale,
                              img.shape)
...
class RandomAffine6(object):
    ...
    def __init__(self, anglez=0, shear=0, translate=(0, 0), scale=(1, 1), resample='BILINEAR', fillcolor=(0, 0, 0)):
    ...
    @staticmethod
    def get_params(img_size, anglez_range=(0, 0), shear_range=(0, 0), translate=(0, 0), scale_ranges=(1, 1)):
        """Get parameters for affine transformation
